...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MessagesStatus', fields ['message', 'user']
        db.create_unique(u'generics_messagesstatus', ['message_id', 'user_id'])

        # Adding index on 'Messages', fields ['msg_code']
        db.create_index(u'generics_messages', ['msg_code'])


    def backwards(self, orm):
        # Removing index on 'Messages', fields ['msg_code']
        db.delete_index(u'generics_messages', ['msg_code'])

        # Removing unique constraint on 'MessagesStatus', fields ['message', 'user']
        db.delete_unique(u'generics_messagesstatus', ['message_id', 'user_id'])
