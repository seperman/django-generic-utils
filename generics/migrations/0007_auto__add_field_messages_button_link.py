...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.button_link'
        db.add_column(u'generics_messages', 'button_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.button_link'
        db.delete_column(u'generics_messages', 'button_link')
    ...
    models = {
        ...
        u'generics.messages': {
            ...
            'button_link': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
