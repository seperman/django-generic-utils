...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CeleryTasks.status'
        db.alter_column(u'generics_celerytasks', 'status', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'CeleryTasks.status'
        db.alter_column(u'generics_celerytasks', 'status', self.gf('django.db.models.fields.CharField')(max_length=12))
