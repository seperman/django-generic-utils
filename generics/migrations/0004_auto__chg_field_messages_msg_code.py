...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Messages.msg_code'
        db.alter_column(u'generics_messages', 'msg_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))

    def backwards(self, orm):

        # Changing field 'Messages.msg_code'
        db.alter_column(u'generics_messages', 'msg_code', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
    ...
    models = {
        ...
        u'generics.messages': {
            ...
            'msg_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
